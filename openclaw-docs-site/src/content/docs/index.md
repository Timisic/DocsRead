...
- [安全、风险与是否值得使用](./modules/07-safety-and-fit.md)
...
OpenClaw 是一个强大的 AI 助手框架，它允许你通过聊天平台（如飞书、微信、Discord、WhatsApp 等）来操作你的电脑、管理任务、编写代码等。

**核心特点**：
- 多平台支持：可以在你常用的聊天软件上使用
- 高度可配置：支持自定义 Skills、Agents 等
- 自动化能力：可以设置定时任务、工作流等
- 远程操作：即使不在电脑前，也能控制你的电脑。几乎任何电脑上的操作都可以通过聊天平台+配置Skill/MCP/Script完成。

> 如果要用起来这个工具，并且未来想要越用越方便的话，前期肯定少不了要进行非常长时间的配置。
...
5. **[安全、风险与是否值得使用](./modules/07-safety-and-fit.md)** - 先判断自己是否真的需要它
6. **场景模块** - 选择适合你的使用场景
