...
| 文件 | 作用 | 是否必需 |
|-----|------|---------|
| **SOUL.md** | 定义助手的 persona（人格）、语气、边界 | ✅ 必需 |
| **USER.md** | 定义用户是谁，如何称呼用户 | ✅ 必需 |
| **IDENTITY.md** | 定义助手的名字、风格、emoji | ✅ 必需 |
| **AGENTS.md** | 定义助手的操作指令、规则、优先级 | ✅ 必需 |
| **TOOLS.md** | 本地工具和使用的约定说明 | ✅ 必需 |
| **HEARTBEAT.md** | 心跳任务的检查清单 | ⚪ 可选 |
| **MEMORY.md** | 长期记忆的精选内容（仅私有会话加载） | ⚪ 可选 |
